/**
 * ✏️ Alle persoonlijke info (behalve de projecten) staat in dit bestand:
 * naam, tagline en de intro-teksten. Pas de tekst hier aan en de site
 * werkt zichzelf bij.
 */
...
export const profile = {
  ...
  tagline: "Student Game Development",

  // Links (null = niet tonen)
  itchUrl: "https://rhijnl.itch.io",
  linkedinUrl: "https://www.linkedin.com/in/lizanne-van-rhijn-05206a3a6",

  // Korte tekst onder de foto op de homepage
  heroIntro:
    "Leergierige en gedreven student met een passie voor softwareontwikkeling, game design en virtual reality.",
